...
public class MappedFeature extends BaseFeature {

	private final Feature[] features;
	private final Map<FeatureCode, Map<String, String>> mappings = new HashMap<FeatureCode, Map<String, String>>();

	public MappedFeature(final FeatureCode code, final Schema schema,
	...
	public MappedFeature(final FeatureCode code, final Schema schema, final Feature... features) {
		this(code, schema, schema.autoMapping(features), features);
	}
	
	public MappedFeature(final FeatureCode code, final Feature... features) {
